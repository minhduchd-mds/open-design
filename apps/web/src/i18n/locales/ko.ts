...
export const ko: Dict = {
  ...
  'visualInspiration.tabLabel': '시각 영감',
  'visualInspiration.title': '시각 영감 찾기',
  'visualInspiration.description': '생성을 시작하기 전에 템플릿과 커뮤니티 라이브러리에서 가까운 예시를 고르세요.',
  'visualInspiration.searchPlaceholder': '의도, 스타일, 플랫폼으로 예시 검색...',
  'visualInspiration.searchAria': '시각 영감 예시 검색',
  'visualInspiration.sourceFilterAria': '시각 영감 소스',
  'visualInspiration.sourceAll': '전체',
  'visualInspiration.sourceTemplates': '템플릿',
  'visualInspiration.sourceCommunity': '커뮤니티',
  'visualInspiration.surfaceFilterAria': '시각 영감 플랫폼',
  'visualInspiration.surfaceAll': '전체',
  'visualInspiration.surfaceWeb': '웹',
  'visualInspiration.surfaceMobile': '모바일',
  'visualInspiration.pluginLoadError': '커뮤니티 예시를 불러오지 못했습니다. 템플릿 매칭은 계속 사용할 수 있습니다.',
  'visualInspiration.empty': '일치하는 예시가 없습니다. 더 넓게 검색하거나 이 단계를 건너뛰세요.',
  'visualInspiration.loading': '영감 라이브러리 불러오는 중...',
  'visualInspiration.selectedStatus': '선택됨: {title}',
  'visualInspiration.selectionHint': '참조 하나를 선택하거나, 건너뛰고 브리프로 계속하세요.',
  'visualInspiration.matchedTerms': '{terms}와 일치',
  'visualInspiration.select': '선택',
  'visualInspiration.selected': '선택됨',
  'visualInspiration.preview': '미리보기',
  'visualInspiration.notesPlaceholder': '가져올 요소를 적어주세요: 레이아웃, 밀도, 타이포그래피, 모션...',
  'visualInspiration.skip': '건너뛰기',
  'visualInspiration.submit': '제출',
  'visualInspiration.closePreview': '미리보기 닫기',
  'visualInspiration.noPreview': '이 예시에는 미리보기가 없습니다.',
  ...
  'visualInspiration.contextSelectedLabel': '선택한 예시',
  'visualInspiration.contextSourceLabel': '소스',
  'visualInspiration.contextTagsLabel': '일치한 태그',
  'visualInspiration.contextPromptLabel': '예시 프롬프트',
  'visualInspiration.contextPreviewLabel': '미리보기',
  'visualInspiration.contextNotesLabel': '사용자 메모',
  'visualInspiration.contextInstruction': '레이아웃 리듬, 밀도, 타이포그래피 성격, 절제된 팔레트, 상호작용 단서의 시각 참고로 사용하세요. 현재 브리프에 맞게 조정하고 보호된 브랜드나 콘텐츠를 그대로 복사하지 마세요.',
  'visualInspiration.contextSkippedBody': '선택한 예시가 없습니다. 브리프 답변을 바탕으로 가장 적합한 시각 방향을 직접 선택하세요.',
