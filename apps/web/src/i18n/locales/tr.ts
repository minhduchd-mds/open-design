...
export const tr: Dict = {
  ...
  'visualInspiration.tabLabel': 'Görsel ilham',
  'visualInspiration.title': 'Görsel ilham bul',
  'visualInspiration.description': 'Üretim başlamadan önce şablon ve topluluk kitaplığından yakın bir örnek seçin.',
  'visualInspiration.searchPlaceholder': 'Niyet, stil, platforma göre örnek ara...',
  'visualInspiration.searchAria': 'Görsel ilham örneklerini ara',
  'visualInspiration.sourceFilterAria': 'Görsel ilham kaynağı',
  'visualInspiration.sourceAll': 'Tümü',
  'visualInspiration.sourceTemplates': 'Şablonlar',
  'visualInspiration.sourceCommunity': 'Topluluk',
  'visualInspiration.surfaceFilterAria': 'Görsel ilham platformu',
  'visualInspiration.surfaceAll': 'Tümü',
  'visualInspiration.surfaceWeb': 'Web',
  'visualInspiration.surfaceMobile': 'Mobil',
  'visualInspiration.pluginLoadError': 'Topluluk örnekleri yüklenemedi. Şablon eşleşmeleri hâlâ kullanılabilir.',
  'visualInspiration.empty': 'Eşleşen örnek yok. Daha geniş arayın veya bu adımı atlayın.',
  'visualInspiration.loading': 'İlham kitaplığı yükleniyor...',
  'visualInspiration.selectedStatus': 'Seçildi: {title}',
  'visualInspiration.selectionHint': 'Bir referans seçin ya da atlayıp brief ile devam edin.',
  'visualInspiration.matchedTerms': '{terms} ile eşleşti',
  'visualInspiration.select': 'Seç',
  'visualInspiration.selected': 'Seçildi',
  'visualInspiration.preview': 'Önizleme',
  'visualInspiration.notesPlaceholder': 'Alınacak şeyleri yazın: yerleşim, yoğunluk, tipografi, hareket...',
  'visualInspiration.skip': 'Atla',
  'visualInspiration.submit': 'Gönder',
  'visualInspiration.closePreview': 'Önizlemeyi kapat',
  'visualInspiration.noPreview': 'Bu örnek için önizleme yok.',
  ...
  'visualInspiration.contextSelectedLabel': 'Seçilen örnek',
  'visualInspiration.contextSourceLabel': 'Kaynak',
  'visualInspiration.contextTagsLabel': 'Eşleşen etiketler',
  'visualInspiration.contextPromptLabel': 'Örnek prompt',
  'visualInspiration.contextPreviewLabel': 'Önizleme',
  'visualInspiration.contextNotesLabel': 'Kullanıcı notları',
  'visualInspiration.contextInstruction': 'Bunu yerleşim ritmi, yoğunluk, tipografik duruş, palet ölçülülüğü ve etkileşim ipuçları için görsel referans olarak kullanın; mevcut briefe uyarlayın ve korumalı marka ya da içeriği birebir kopyalamayın.',
  'visualInspiration.contextSkippedBody': 'Örnek seçilmedi; brief yanıtlarından devam edin ve en uygun görsel yönü kendiniz seçin.',
