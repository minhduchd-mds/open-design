...
export const th: Dict = {
  ...
  'visualInspiration.tabLabel': 'แรงบันดาลใจภาพ',
  'visualInspiration.title': 'หาแรงบันดาลใจภาพ',
  'visualInspiration.description': 'เลือกตัวอย่างที่ใกล้เคียงจากคลังเทมเพลตและชุมชนก่อนเริ่มสร้างงาน',
  'visualInspiration.searchPlaceholder': 'ค้นหาตามเป้าหมาย สไตล์ แพลตฟอร์ม...',
  'visualInspiration.searchAria': 'ค้นหาตัวอย่างแรงบันดาลใจภาพ',
  'visualInspiration.sourceFilterAria': 'แหล่งที่มาของแรงบันดาลใจภาพ',
  'visualInspiration.sourceAll': 'ทั้งหมด',
  'visualInspiration.sourceTemplates': 'เทมเพลต',
  'visualInspiration.sourceCommunity': 'ชุมชน',
  'visualInspiration.surfaceFilterAria': 'แพลตฟอร์มของแรงบันดาลใจภาพ',
  'visualInspiration.surfaceAll': 'ทั้งหมด',
  'visualInspiration.surfaceWeb': 'เว็บ',
  'visualInspiration.surfaceMobile': 'มือถือ',
  'visualInspiration.pluginLoadError': 'โหลดตัวอย่างจากชุมชนไม่ได้ แต่ยังใช้ผลลัพธ์จากเทมเพลตได้',
  'visualInspiration.empty': 'ไม่พบตัวอย่างที่ตรง ลองค้นหาให้กว้างขึ้นหรือข้ามขั้นตอนนี้',
  'visualInspiration.loading': 'กำลังโหลดคลังแรงบันดาลใจ...',
  'visualInspiration.selectedStatus': 'เลือกแล้ว: {title}',
  'visualInspiration.selectionHint': 'เลือกหนึ่งตัวอย่างอ้างอิง หรือข้ามและดำเนินต่อจากบรีฟ',
  'visualInspiration.matchedTerms': 'ตรงกับ {terms}',
  'visualInspiration.select': 'เลือก',
  'visualInspiration.selected': 'เลือกแล้ว',
  'visualInspiration.preview': 'ดูตัวอย่าง',
  'visualInspiration.notesPlaceholder': 'เพิ่มโน้ตสิ่งที่อยากยืม: เลย์เอาต์ ความหนาแน่น ตัวอักษร การเคลื่อนไหว...',
  'visualInspiration.skip': 'ข้าม',
  'visualInspiration.submit': 'ส่ง',
  'visualInspiration.closePreview': 'ปิดตัวอย่าง',
  'visualInspiration.noPreview': 'ไม่มีตัวอย่างให้ดูสำหรับรายการนี้',
  ...
  'visualInspiration.contextSelectedLabel': 'ตัวอย่างที่เลือก',
  'visualInspiration.contextSourceLabel': 'แหล่งที่มา',
  'visualInspiration.contextTagsLabel': 'แท็กที่ตรงกัน',
  'visualInspiration.contextPromptLabel': 'พรอมป์ตัวอย่าง',
  'visualInspiration.contextPreviewLabel': 'ตัวอย่าง',
  'visualInspiration.contextNotesLabel': 'โน้ตผู้ใช้',
  'visualInspiration.contextInstruction': 'ใช้เป็นภาพอ้างอิงสำหรับจังหวะเลย์เอาต์ ความหนาแน่น บุคลิกตัวอักษร การคุมพาเลต และสัญญาณการโต้ตอบ ปรับให้เข้ากับบรีฟปัจจุบัน และอย่าคัดลอกแบรนด์หรือเนื้อหาที่มีการคุ้มครองแบบคำต่อคำ',
  'visualInspiration.contextSkippedBody': 'ไม่ได้เลือกตัวอย่าง ให้ดำเนินต่อจากคำตอบในบรีฟและเลือกทิศทางภาพที่เหมาะสมที่สุดเอง',
