...
export const fr: Dict = {
  ...
  'designFiles.newSketch': 'Ouvrir le carnet de croquis',
  'designFiles.empty': 'Les créations apparaîtront ici, ou ouvrez le carnet de croquis pour dessiner vous-même',
  ...
  'tool.askQuestionCustomPlaceholder': 'Ou écrivez votre propre réponse...',
