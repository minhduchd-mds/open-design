...
export const ar: Dict = {
  ...
  'visualInspiration.tabLabel': 'إلهام بصري',
  'visualInspiration.title': 'ابحث عن إلهام بصري',
  'visualInspiration.description': 'اختر مثالًا قريبًا من مكتبة القوالب والمجتمع قبل بدء التوليد.',
  'visualInspiration.searchPlaceholder': 'ابحث حسب النية أو النمط أو المنصة...',
  'visualInspiration.searchAria': 'البحث في أمثلة الإلهام البصري',
  'visualInspiration.sourceFilterAria': 'مصدر الإلهام البصري',
  'visualInspiration.sourceAll': 'الكل',
  'visualInspiration.sourceTemplates': 'القوالب',
  'visualInspiration.sourceCommunity': 'المجتمع',
  'visualInspiration.surfaceFilterAria': 'منصة الإلهام البصري',
  'visualInspiration.surfaceAll': 'الكل',
  'visualInspiration.surfaceWeb': 'الويب',
  'visualInspiration.surfaceMobile': 'الجوال',
  'visualInspiration.pluginLoadError': 'تعذر تحميل أمثلة المجتمع. لا تزال مطابقات القوالب متاحة.',
  'visualInspiration.empty': 'لا توجد أمثلة مطابقة. جرب بحثًا أوسع أو تخط هذه الخطوة.',
  'visualInspiration.loading': 'جار تحميل مكتبة الإلهام...',
  'visualInspiration.selectedStatus': 'تم الاختيار: {title}',
  'visualInspiration.selectionHint': 'اختر مرجعًا واحدًا، أو تخط وتابع من الموجز.',
  'visualInspiration.matchedTerms': 'مطابق: {terms}',
  'visualInspiration.select': 'اختيار',
  'visualInspiration.selected': 'مختار',
  'visualInspiration.preview': 'معاينة',
  'visualInspiration.notesPlaceholder': 'أضف ملاحظات حول ما تريد اقتباسه: التخطيط، الكثافة، الخطوط، الحركة...',
  'visualInspiration.skip': 'تخطي',
  'visualInspiration.submit': 'إرسال',
  'visualInspiration.closePreview': 'إغلاق المعاينة',
  'visualInspiration.noPreview': 'لا توجد معاينة لهذا المثال.',
  ...
  'visualInspiration.contextSelectedLabel': 'المثال المختار',
  'visualInspiration.contextSourceLabel': 'المصدر',
  'visualInspiration.contextTagsLabel': 'الوسوم المطابقة',
  'visualInspiration.contextPromptLabel': 'مثال الطلب',
  'visualInspiration.contextPreviewLabel': 'المعاينة',
  'visualInspiration.contextNotesLabel': 'ملاحظات المستخدم',
  'visualInspiration.contextInstruction': 'استخدمه كمرجع بصري لإيقاع التخطيط والكثافة وطابع الخطوط وضبط الألوان وإشارات التفاعل؛ عدله حسب الموجز الحالي ولا تنسخ علامة أو محتوى محميًا حرفيًا.',
  'visualInspiration.contextSkippedBody': 'لم يتم اختيار مثال؛ تابع من إجابات الموجز واختر بنفسك الاتجاه البصري الأنسب.',
