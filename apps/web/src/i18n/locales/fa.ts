...
export const fa: Dict = {
  ...
  'visualInspiration.tabLabel': 'الهام بصری',
  'visualInspiration.title': 'یافتن الهام بصری',
  'visualInspiration.description': 'پیش از شروع تولید، یک نمونه نزدیک از کتابخانه قالب‌ها و جامعه انتخاب کنید.',
  'visualInspiration.searchPlaceholder': 'جستجوی نمونه‌ها بر اساس هدف، سبک، پلتفرم...',
  'visualInspiration.searchAria': 'جستجوی نمونه‌های الهام بصری',
  'visualInspiration.sourceFilterAria': 'منبع الهام بصری',
  'visualInspiration.sourceAll': 'همه',
  'visualInspiration.sourceTemplates': 'قالب‌ها',
  'visualInspiration.sourceCommunity': 'جامعه',
  'visualInspiration.surfaceFilterAria': 'پلتفرم الهام بصری',
  'visualInspiration.surfaceAll': 'همه',
  'visualInspiration.surfaceWeb': 'وب',
  'visualInspiration.surfaceMobile': 'موبایل',
  'visualInspiration.pluginLoadError': 'نمونه‌های جامعه بارگیری نشدند. تطبیق‌های قالب همچنان در دسترس است.',
  'visualInspiration.empty': 'نمونه مطابقی پیدا نشد. جستجوی گسترده‌تری امتحان کنید یا این مرحله را رد کنید.',
  'visualInspiration.loading': 'در حال بارگیری کتابخانه الهام...',
  'visualInspiration.selectedStatus': 'انتخاب‌شده: {title}',
  'visualInspiration.selectionHint': 'یک مرجع انتخاب کنید، یا رد کنید و با بریف ادامه دهید.',
  'visualInspiration.matchedTerms': 'مطابق با {terms}',
  'visualInspiration.select': 'انتخاب',
  'visualInspiration.selected': 'انتخاب شد',
  'visualInspiration.preview': 'پیش‌نمایش',
  'visualInspiration.notesPlaceholder': 'یادداشت‌هایی درباره موارد قابل اقتباس اضافه کنید: چیدمان، تراکم، تایپوگرافی، حرکت...',
  'visualInspiration.skip': 'رد کردن',
  'visualInspiration.submit': 'ارسال',
  'visualInspiration.closePreview': 'بستن پیش‌نمایش',
  'visualInspiration.noPreview': 'برای این نمونه پیش‌نمایشی در دسترس نیست.',
  ...
  'visualInspiration.contextSelectedLabel': 'نمونه انتخاب‌شده',
  'visualInspiration.contextSourceLabel': 'منبع',
  'visualInspiration.contextTagsLabel': 'برچسب‌های مطابق',
  'visualInspiration.contextPromptLabel': 'نمونه پرامپت',
  'visualInspiration.contextPreviewLabel': 'پیش‌نمایش',
  'visualInspiration.contextNotesLabel': 'یادداشت‌های کاربر',
  'visualInspiration.contextInstruction': 'از آن به عنوان مرجع بصری برای ریتم چیدمان، تراکم، حس تایپوگرافی، کنترل پالت و نشانه‌های تعامل استفاده کنید؛ آن را با بریف فعلی تطبیق دهید و برند یا محتوای محافظت‌شده را عیناً کپی نکنید.',
  'visualInspiration.contextSkippedBody': 'هیچ نمونه‌ای انتخاب نشد؛ از پاسخ‌های بریف ادامه دهید و مناسب‌ترین جهت بصری را خودتان انتخاب کنید.',
