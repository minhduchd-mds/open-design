...
export const en: Dict = {
  ...
  'visualInspiration.tabLabel': 'Visual inspiration',
  'visualInspiration.title': 'Find visual inspiration',
  'visualInspiration.description': 'Pick a close example from the template and community library before generation starts.',
  'visualInspiration.searchPlaceholder': 'Search examples by intent, style, platform...',
  'visualInspiration.searchAria': 'Search visual inspiration examples',
  'visualInspiration.sourceFilterAria': 'Visual inspiration source',
  'visualInspiration.sourceAll': 'All',
  'visualInspiration.sourceTemplates': 'Templates',
  'visualInspiration.sourceCommunity': 'Community',
  'visualInspiration.surfaceFilterAria': 'Visual inspiration platform',
  'visualInspiration.surfaceAll': 'All',
  'visualInspiration.surfaceWeb': 'Web',
  'visualInspiration.surfaceMobile': 'Mobile',
  'visualInspiration.pluginLoadError': 'Community examples could not be loaded. Template matches are still available.',
  'visualInspiration.empty': 'No matching examples. Try a broader search or skip this step.',
  'visualInspiration.loading': 'Loading inspiration library...',
  'visualInspiration.selectedStatus': 'Selected: {title}',
  'visualInspiration.selectionHint': 'Select one reference, or skip and continue with the brief.',
  'visualInspiration.matchedTerms': 'Matched {terms}',
  'visualInspiration.select': 'Select',
  'visualInspiration.selected': 'Selected',
  'visualInspiration.preview': 'Preview',
  'visualInspiration.notesPlaceholder': 'Add notes about what to borrow: layout, density, typography, motion...',
  'visualInspiration.skip': 'Skip',
  'visualInspiration.submit': 'Submit',
  'visualInspiration.closePreview': 'Close preview',
  'visualInspiration.noPreview': 'No preview available for this example.',
  ...
  'visualInspiration.contextSelectedLabel': 'Selected example',
  'visualInspiration.contextSourceLabel': 'Source',
  'visualInspiration.contextTagsLabel': 'Matched tags',
  'visualInspiration.contextPromptLabel': 'Example prompt',
  'visualInspiration.contextPreviewLabel': 'Preview',
  'visualInspiration.contextNotesLabel': 'User notes',
  'visualInspiration.contextInstruction': 'Use this as visual reference for layout rhythm, density, typography posture, palette restraint, and interaction cues; adapt it to the current brief and do not copy protected brand/content verbatim.',
  'visualInspiration.contextSkippedBody': 'No example was selected; continue from the brief answers and choose the best matching visual direction yourself.',
