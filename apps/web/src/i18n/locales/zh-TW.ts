...
export const zhTW: Dict = {
  ...
  'designBrowser.status.downloadAssistHint': '請在此選單點擊「下載頁面」，等待完成後回到左側點擊「繼續擷取」。',
  ...
  'chat.brandBrowserAssistDownloadGuideDetails': '在 Browser 裡打開選單，點擊「下載頁面」並等待完成。然後回到左側點擊「繼續擷取」。',
