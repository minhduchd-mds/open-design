...
export const zhTW: Dict = {
  ...
  'visualInspiration.tabLabel': '視覺靈感',
  'visualInspiration.title': '尋找視覺靈感',
  'visualInspiration.description': '開工前先從模板和社群案例庫裡挑一個接近的視覺參考。',
  'visualInspiration.searchPlaceholder': '依需求、風格、平台搜尋 examples...',
  'visualInspiration.searchAria': '搜尋視覺靈感案例',
  'visualInspiration.sourceFilterAria': '視覺靈感來源',
  'visualInspiration.sourceAll': '全部',
  'visualInspiration.sourceTemplates': '模板',
  'visualInspiration.sourceCommunity': '社群',
  'visualInspiration.surfaceFilterAria': '視覺靈感平台',
  'visualInspiration.surfaceAll': '全部',
  'visualInspiration.surfaceWeb': 'Web',
  'visualInspiration.surfaceMobile': 'Mobile',
  'visualInspiration.pluginLoadError': '社群 examples 載入失敗，仍可選擇模板匹配結果。',
  'visualInspiration.empty': '沒有匹配的案例。可以放寬搜尋，或略過這一步。',
  'visualInspiration.loading': '正在載入靈感庫...',
  'visualInspiration.selectedStatus': '已選擇：{title}',
  'visualInspiration.selectionHint': '選擇一個參考，或略過並繼續使用目前簡報。',
  'visualInspiration.matchedTerms': '匹配 {terms}',
  'visualInspiration.select': '選擇',
  'visualInspiration.selected': '已選',
  'visualInspiration.preview': '預覽',
  'visualInspiration.notesPlaceholder': '補充想借鑑什麼：版面、密度、字體氣質、動效...',
  'visualInspiration.skip': '略過',
  'visualInspiration.submit': '提交',
  'visualInspiration.closePreview': '關閉預覽',
  'visualInspiration.noPreview': '這個案例沒有可用預覽。',
  ...
  'visualInspiration.contextSelectedLabel': '選擇的案例',
  'visualInspiration.contextSourceLabel': '來源',
  'visualInspiration.contextTagsLabel': '匹配標籤',
  'visualInspiration.contextPromptLabel': '示例 Prompt',
  'visualInspiration.contextPreviewLabel': '預覽',
  'visualInspiration.contextNotesLabel': '使用者備註',
  'visualInspiration.contextInstruction': '把它作為版面節奏、資訊密度、字體氣質、配色克制度和互動細節的視覺參考；根據目前需求改寫，不要逐字複製受保護的品牌或內容。',
  'visualInspiration.contextSkippedBody': '未選擇案例；繼續根據簡報答案自行選擇最匹配的視覺方向。',
