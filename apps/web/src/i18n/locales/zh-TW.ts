...
export const zhTW: Dict = {
  ...
  'settings.onboardingUseFundraising': '💸 募資 / 投資人材料',
  'settings.onboardingUseSales': '🤝 銷售提案 / 客戶 Pitch',
  'settings.onboardingUseConsulting': '📑 顧問交付物',
  ...
  'homeHero.title': '你要交付什麼成果？',
  'homeHero.startWithTemplate': '先選要交付的成果',
  ...
  'homeHero.subtitlePrefix': '先選範本，再用你的檔案、品牌和 agent 繼續細化。',
  'homeHero.placeholder': '描述你要交付的業務成果…',
  'homeHero.placeholderActive': '編輯這份起始 brief，或寫下你的需求…',
  'homeHero.carousel.hint': '上傳檔案、連結設計系統，或描述你想創作的內容',
  'homeHero.carousel.onePageBrief': '撰寫一頁客戶級專案 brief',
  'homeHero.carousel.notesToDeck': '把我的筆記變成投資人 Deck',
  'homeHero.carousel.signupFlow': '做一個 SaaS 註冊轉化原型',
  ...
  'homeHero.carousel.ordersDashboard': '製作高管 KPI 儀表板',
  'homeHero.carousel.productDetail': '設計定價和產品頁',
  'homeHero.carousel.caseStudy': '梳理客戶級案例研究',
  'homeHero.carousel.landingIntro': '設計高級落地頁',
  'homeHero.carousel.pitchDeck': '製作投資人路演 Deck',
  ...
  'onboarding.buildTitle': '讓每個交付物都有高級感',
  'onboarding.buildBody': '最高效的路徑是先沉澱可複用設計系統，再讓募資 Deck、SaaS 原型、資料儀表板、報告和落地頁繼承同一套審美。',
  'onboarding.buildBenefitMemoryTitle': '可複用的審美層',
  'onboarding.buildBenefitMemoryBody': '顏色、字體、間距、元件、語氣和參考樣例會沉澱成 agent 可複用的規則。',
  'onboarding.buildBenefitAlignedTitle': '客戶交付保持一致',
  'onboarding.buildBenefitAlignedBody': '路演稿、銷售提案、CRM 介面、儀表板、PDF 和行銷頁面都會使用同一套標準。',
  'onboarding.buildBenefitSourcesTitle': '從既有證明開始',
  'onboarding.buildBenefitSourcesBody': '可以使用網站、倉庫、DESIGN.md、截圖、字體、Figma 或已經交付過的客戶作品。',
  'onboarding.buildPreviewLabel': '可複用系統',
  'onboarding.buildStart': '先建立設計系統',
  'onboarding.buildHome': '探索範本',
