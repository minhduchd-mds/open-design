...
export const it: Dict = {
  ...
  'visualInspiration.tabLabel': 'Ispirazione visiva',
  'visualInspiration.title': 'Trova ispirazione visiva',
  'visualInspiration.description': 'Scegli un esempio vicino dalla libreria di template e community prima di generare.',
  'visualInspiration.searchPlaceholder': 'Cerca esempi per intento, stile, piattaforma...',
  'visualInspiration.searchAria': 'Cerca esempi di ispirazione visiva',
  'visualInspiration.sourceFilterAria': 'Fonte di ispirazione visiva',
  'visualInspiration.sourceAll': 'Tutti',
  'visualInspiration.sourceTemplates': 'Template',
  'visualInspiration.sourceCommunity': 'Community',
  'visualInspiration.surfaceFilterAria': 'Piattaforma di ispirazione visiva',
  'visualInspiration.surfaceAll': 'Tutti',
  'visualInspiration.surfaceWeb': 'Web',
  'visualInspiration.surfaceMobile': 'Mobile',
  'visualInspiration.pluginLoadError': 'Impossibile caricare gli esempi della community. Le corrispondenze dei template restano disponibili.',
  'visualInspiration.empty': 'Nessun esempio corrispondente. Prova una ricerca più ampia o salta questo passaggio.',
  'visualInspiration.loading': 'Caricamento libreria di ispirazione...',
  'visualInspiration.selectedStatus': 'Selezionato: {title}',
  'visualInspiration.selectionHint': 'Seleziona un riferimento, oppure salta e continua dal brief.',
  'visualInspiration.matchedTerms': 'Corrisponde a {terms}',
  'visualInspiration.select': 'Seleziona',
  'visualInspiration.selected': 'Selezionato',
  'visualInspiration.preview': 'Anteprima',
  'visualInspiration.notesPlaceholder': 'Aggiungi note su layout, densità, tipografia, movimento...',
  'visualInspiration.skip': 'Salta',
  'visualInspiration.submit': 'Invia',
  'visualInspiration.closePreview': 'Chiudi anteprima',
  'visualInspiration.noPreview': 'Nessuna anteprima disponibile per questo esempio.',
  ...
  'visualInspiration.contextSelectedLabel': 'Esempio selezionato',
  'visualInspiration.contextSourceLabel': 'Fonte',
  'visualInspiration.contextTagsLabel': 'Tag corrispondenti',
  'visualInspiration.contextPromptLabel': 'Prompt di esempio',
  'visualInspiration.contextPreviewLabel': 'Anteprima',
  'visualInspiration.contextNotesLabel': 'Note utente',
  'visualInspiration.contextInstruction': 'Usalo come riferimento visivo per ritmo del layout, densità, postura tipografica, sobrietà della palette e segnali di interazione; adattalo al brief attuale e non copiare letteralmente brand o contenuti protetti.',
  'visualInspiration.contextSkippedBody': 'Nessun esempio selezionato; continua dalle risposte del brief e scegli tu la direzione visiva più adatta.',
