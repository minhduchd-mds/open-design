...
export const it: Dict = {
  ...
  'designFiles.newSketch': 'Apri lavagna da disegno',
  'designFiles.empty': 'Le creazioni appariranno qui, oppure apri una lavagna da disegno per disegnare tu',
  ...
  'tool.askQuestionCustomPlaceholder': 'Oppure scrivi una risposta...',
  'tool.write': 'Scrivi',
  'tool.edit': 'Modifica',
  'tool.read': 'Leggi',
  'tool.bash': 'Bash',
