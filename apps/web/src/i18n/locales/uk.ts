...
export const uk: Dict = {
  ...
  'designFiles.newSketch': 'Відкрити дошку для ескізів',
  'designFiles.empty': 'Створені дизайни з\'являться тут, або відкрийте дошку для ескізів і намалюйте самостійно',
