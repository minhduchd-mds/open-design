...
export const ptBR: Dict = {
  ...
  'designFiles.newSketch': 'Abrir prancheta de desenho',
  'designFiles.empty': 'As criações aparecerão aqui, ou abra uma prancheta de desenho para desenhar você mesmo',
