...
export const zhCN: Dict = {
  ...
  'designBrowser.status.downloadAssistHint': '请在此菜单点击“下载页面”，等待完成后回到左侧点击“继续提取”。',
  ...
  'chat.brandBrowserAssistDownloadGuideDetails': '在 Browser 里打开菜单，点击“下载页面”并等待完成。然后回到左侧点击“继续提取”。',
