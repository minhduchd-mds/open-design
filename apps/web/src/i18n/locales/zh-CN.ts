...
export const zhCN: Dict = {
  ...
  'chat.resumeConversation': '在新对话中继续当前聊天',
  ...
  'chat.addResourcesTitle': '添加资源',
  'chat.addResourcesAria': '向聊天添加资源',
  ...
  'designFiles.newSketch': '手绘画板',
  'designFiles.empty': '生成的设计会出现在这里，也可以自己先画一张',
