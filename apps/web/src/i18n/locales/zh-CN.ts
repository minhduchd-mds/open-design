...
export const zhCN: Dict = {
  ...
  'visualInspiration.tabLabel': '视觉灵感',
  'visualInspiration.title': '寻找视觉灵感',
  'visualInspiration.description': '开工前先从模板和社区案例库里挑一个接近的视觉参考。',
  'visualInspiration.searchPlaceholder': '按需求、风格、平台搜索 examples...',
  'visualInspiration.searchAria': '搜索视觉灵感案例',
  'visualInspiration.sourceFilterAria': '视觉灵感来源',
  'visualInspiration.sourceAll': '全部',
  'visualInspiration.sourceTemplates': '模板',
  'visualInspiration.sourceCommunity': '社区',
  'visualInspiration.surfaceFilterAria': '视觉灵感平台',
  'visualInspiration.surfaceAll': '全部',
  'visualInspiration.surfaceWeb': 'Web',
  'visualInspiration.surfaceMobile': 'Mobile',
  'visualInspiration.pluginLoadError': '社区 examples 加载失败，仍可选择模板匹配结果。',
  'visualInspiration.empty': '没有匹配的案例。可以放宽搜索，或跳过这一步。',
  'visualInspiration.loading': '正在加载灵感库...',
  'visualInspiration.selectedStatus': '已选择：{title}',
  'visualInspiration.selectionHint': '选择一个参考，或跳过并继续使用当前简报。',
  'visualInspiration.matchedTerms': '匹配 {terms}',
  'visualInspiration.select': '选择',
  'visualInspiration.selected': '已选',
  'visualInspiration.preview': '预览',
  'visualInspiration.notesPlaceholder': '补充想借鉴什么：布局、密度、字体气质、动效...',
  'visualInspiration.skip': '跳过',
  'visualInspiration.submit': '提交',
  'visualInspiration.closePreview': '关闭预览',
  'visualInspiration.noPreview': '这个案例没有可用预览。',
  ...
  'visualInspiration.contextSelectedLabel': '选择的案例',
  'visualInspiration.contextSourceLabel': '来源',
  'visualInspiration.contextTagsLabel': '匹配标签',
  'visualInspiration.contextPromptLabel': '示例 Prompt',
  'visualInspiration.contextPreviewLabel': '预览',
  'visualInspiration.contextNotesLabel': '用户备注',
  'visualInspiration.contextInstruction': '把它作为布局节奏、信息密度、字体气质、配色克制度和交互细节的视觉参考；根据当前需求改写，不要逐字复制受保护的品牌或内容。',
  'visualInspiration.contextSkippedBody': '未选择案例；继续根据简报答案自行选择最匹配的视觉方向。',
