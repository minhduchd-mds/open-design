...
export const zhCN: Dict = {
  ...
  'settings.onboardingUseFundraising': '💸 融资 / 投资人材料',
  'settings.onboardingUseSales': '🤝 销售提案 / 客户 Pitch',
  'settings.onboardingUseConsulting': '📑 咨询交付物',
  ...
  'homeHero.title': '你要交付什么成果？',
  'homeHero.startWithTemplate': '先选要交付的成果',
  ...
  'homeHero.subtitlePrefix': '先选模板，再用你的文件、品牌和 agent 继续细化。',
  'homeHero.placeholder': '描述你要交付的业务成果…',
  'homeHero.placeholderActive': '编辑这份起始 brief，或写下你的需求…',
  'homeHero.carousel.hint': '上传文件、关联设计系统，或描述你想创作的内容',
  'homeHero.carousel.onePageBrief': '撰写一页客户级项目 brief',
  'homeHero.carousel.notesToDeck': '把我的笔记变成投资人 Deck',
  'homeHero.carousel.signupFlow': '做一个 SaaS 注册转化原型',
  ...
  'homeHero.carousel.ordersDashboard': '制作高管 KPI 看板',
  'homeHero.carousel.productDetail': '设计定价和产品页',
  'homeHero.carousel.caseStudy': '梳理客户级案例研究',
  'homeHero.carousel.landingIntro': '设计高级落地页',
  'homeHero.carousel.pitchDeck': '制作投资人路演 Deck',
  ...
  'onboarding.buildTitle': '让每个交付物都有高级感',
  'onboarding.buildBody': '最高效的路径是先沉淀可复用设计系统，再让融资 Deck、SaaS 原型、数据看板、报告和落地页继承同一套审美。',
  'onboarding.buildBenefitMemoryTitle': '可复用的审美层',
  'onboarding.buildBenefitMemoryBody': '颜色、字体、间距、组件、语气和参考样例会沉淀成 agent 可复用的规则。',
  'onboarding.buildBenefitAlignedTitle': '客户交付保持一致',
  'onboarding.buildBenefitAlignedBody': '路演稿、销售提案、CRM 界面、看板、PDF 和营销页面都会使用同一套标准。',
  'onboarding.buildBenefitSourcesTitle': '从已有证明开始',
  'onboarding.buildBenefitSourcesBody': '可以使用网站、仓库、DESIGN.md、截图、字体、Figma 或已经交付过的客户作品。',
  'onboarding.buildPreviewLabel': '可复用系统',
  'onboarding.buildStart': '先构建设计系统',
  'onboarding.buildHome': '探索模板',
