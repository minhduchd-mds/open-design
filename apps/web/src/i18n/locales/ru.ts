...
export const ru: Dict = {
  ...
  'visualInspiration.tabLabel': 'Визуальное вдохновение',
  'visualInspiration.title': 'Найти визуальное вдохновение',
  'visualInspiration.description': 'Перед генерацией выберите близкий пример из библиотеки шаблонов и сообщества.',
  'visualInspiration.searchPlaceholder': 'Искать по задаче, стилю, платформе...',
  'visualInspiration.searchAria': 'Поиск примеров визуального вдохновения',
  'visualInspiration.sourceFilterAria': 'Источник визуального вдохновения',
  'visualInspiration.sourceAll': 'Все',
  'visualInspiration.sourceTemplates': 'Шаблоны',
  'visualInspiration.sourceCommunity': 'Сообщество',
  'visualInspiration.surfaceFilterAria': 'Платформа визуального вдохновения',
  'visualInspiration.surfaceAll': 'Все',
  'visualInspiration.surfaceWeb': 'Веб',
  'visualInspiration.surfaceMobile': 'Мобильные',
  'visualInspiration.pluginLoadError': 'Не удалось загрузить примеры сообщества. Совпадения шаблонов по-прежнему доступны.',
  'visualInspiration.empty': 'Подходящих примеров нет. Попробуйте более широкий поиск или пропустите этот шаг.',
  'visualInspiration.loading': 'Загрузка библиотеки вдохновения...',
  'visualInspiration.selectedStatus': 'Выбрано: {title}',
  'visualInspiration.selectionHint': 'Выберите одну ссылку или пропустите и продолжайте по брифу.',
  'visualInspiration.matchedTerms': 'Совпадает с {terms}',
  'visualInspiration.select': 'Выбрать',
  'visualInspiration.selected': 'Выбрано',
  'visualInspiration.preview': 'Предпросмотр',
  'visualInspiration.notesPlaceholder': 'Добавьте заметки: макет, плотность, типографика, движение...',
  'visualInspiration.skip': 'Пропустить',
  'visualInspiration.submit': 'Отправить',
  'visualInspiration.closePreview': 'Закрыть предпросмотр',
  'visualInspiration.noPreview': 'Для этого примера нет предпросмотра.',
  ...
  'visualInspiration.contextSelectedLabel': 'Выбранный пример',
  'visualInspiration.contextSourceLabel': 'Источник',
  'visualInspiration.contextTagsLabel': 'Совпавшие теги',
  'visualInspiration.contextPromptLabel': 'Пример промпта',
  'visualInspiration.contextPreviewLabel': 'Предпросмотр',
  'visualInspiration.contextNotesLabel': 'Заметки пользователя',
  'visualInspiration.contextInstruction': 'Используйте как визуальную ссылку для ритма макета, плотности, характера типографики, сдержанной палитры и подсказок взаимодействия; адаптируйте под текущий бриф и не копируйте защищенные бренды или контент дословно.',
  'visualInspiration.contextSkippedBody': 'Пример не выбран; продолжайте от ответов в брифе и самостоятельно выберите наиболее подходящее визуальное направление.',
