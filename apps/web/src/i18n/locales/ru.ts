...
export const ru: Dict = {
  ...
  'designFiles.newSketch': 'Открыть доску для набросков',
  'designFiles.empty': 'Созданные дизайны появятся здесь, или откройте доску для набросков и нарисуйте сами',
  ...
  'tool.askQuestionCustomPlaceholder': 'Или введите свой ответ...',
