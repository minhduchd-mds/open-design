...
export const id: Dict = {
  ...
  'visualInspiration.tabLabel': 'Inspirasi visual',
  'visualInspiration.title': 'Cari inspirasi visual',
  'visualInspiration.description': 'Pilih contoh yang mirip dari pustaka template dan komunitas sebelum generasi dimulai.',
  'visualInspiration.searchPlaceholder': 'Cari contoh berdasarkan tujuan, gaya, platform...',
  'visualInspiration.searchAria': 'Cari contoh inspirasi visual',
  'visualInspiration.sourceFilterAria': 'Sumber inspirasi visual',
  'visualInspiration.sourceAll': 'Semua',
  'visualInspiration.sourceTemplates': 'Template',
  'visualInspiration.sourceCommunity': 'Komunitas',
  'visualInspiration.surfaceFilterAria': 'Platform inspirasi visual',
  'visualInspiration.surfaceAll': 'Semua',
  'visualInspiration.surfaceWeb': 'Web',
  'visualInspiration.surfaceMobile': 'Mobile',
  'visualInspiration.pluginLoadError': 'Contoh komunitas tidak dapat dimuat. Kecocokan template masih tersedia.',
  'visualInspiration.empty': 'Tidak ada contoh yang cocok. Coba pencarian lebih luas atau lewati langkah ini.',
  'visualInspiration.loading': 'Memuat pustaka inspirasi...',
  'visualInspiration.selectedStatus': 'Dipilih: {title}',
  'visualInspiration.selectionHint': 'Pilih satu referensi, atau lewati dan lanjutkan dengan brief.',
  'visualInspiration.matchedTerms': 'Cocok dengan {terms}',
  'visualInspiration.select': 'Pilih',
  'visualInspiration.selected': 'Dipilih',
  'visualInspiration.preview': 'Pratinjau',
  'visualInspiration.notesPlaceholder': 'Tambahkan catatan: layout, kepadatan, tipografi, motion...',
  'visualInspiration.skip': 'Lewati',
  'visualInspiration.submit': 'Kirim',
  'visualInspiration.closePreview': 'Tutup pratinjau',
  'visualInspiration.noPreview': 'Tidak ada pratinjau untuk contoh ini.',
  ...
  'visualInspiration.contextSelectedLabel': 'Contoh yang dipilih',
  'visualInspiration.contextSourceLabel': 'Sumber',
  'visualInspiration.contextTagsLabel': 'Tag yang cocok',
  'visualInspiration.contextPromptLabel': 'Prompt contoh',
  'visualInspiration.contextPreviewLabel': 'Pratinjau',
  'visualInspiration.contextNotesLabel': 'Catatan pengguna',
  'visualInspiration.contextInstruction': 'Gunakan sebagai referensi visual untuk ritme layout, kepadatan, karakter tipografi, kendali palet, dan isyarat interaksi; sesuaikan dengan brief saat ini dan jangan menyalin merek atau konten terlindungi secara verbatim.',
  'visualInspiration.contextSkippedBody': 'Tidak ada contoh yang dipilih; lanjutkan dari jawaban brief dan pilih sendiri arah visual yang paling sesuai.',
