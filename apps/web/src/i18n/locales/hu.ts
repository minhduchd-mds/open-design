...
export const hu: Dict = {
  ...
  'designFiles.newSketch': 'Rajztábla megnyitása',
  'designFiles.empty': 'Az elkészült tervek itt jelennek meg, vagy nyiss meg egy rajztáblát és rajzolj saját kezűleg',
