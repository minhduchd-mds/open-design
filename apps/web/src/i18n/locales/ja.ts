...
export const ja: Dict = {
  ...
  'visualInspiration.tabLabel': 'ビジュアル参考',
  'visualInspiration.title': 'ビジュアル参考を探す',
  'visualInspiration.description': '生成を始める前に、テンプレートとコミュニティライブラリから近い例を選びます。',
  'visualInspiration.searchPlaceholder': '目的、スタイル、プラットフォームで例を検索...',
  'visualInspiration.searchAria': 'ビジュアル参考例を検索',
  'visualInspiration.sourceFilterAria': 'ビジュアル参考のソース',
  'visualInspiration.sourceAll': 'すべて',
  'visualInspiration.sourceTemplates': 'テンプレート',
  'visualInspiration.sourceCommunity': 'コミュニティ',
  'visualInspiration.surfaceFilterAria': 'ビジュアル参考のプラットフォーム',
  'visualInspiration.surfaceAll': 'すべて',
  'visualInspiration.surfaceWeb': 'Web',
  'visualInspiration.surfaceMobile': 'モバイル',
  'visualInspiration.pluginLoadError': 'コミュニティ例を読み込めませんでした。テンプレートの一致は引き続き利用できます。',
  'visualInspiration.empty': '一致する例がありません。検索を広げるか、この手順をスキップしてください。',
  'visualInspiration.loading': '参考ライブラリを読み込み中...',
  'visualInspiration.selectedStatus': '選択済み: {title}',
  'visualInspiration.selectionHint': '参照を1つ選ぶか、スキップしてブリーフから続行します。',
  'visualInspiration.matchedTerms': '{terms} に一致',
  'visualInspiration.select': '選択',
  'visualInspiration.selected': '選択済み',
  'visualInspiration.preview': 'プレビュー',
  'visualInspiration.notesPlaceholder': '取り入れたい点を追加: レイアウト、密度、タイポグラフィ、モーション...',
  'visualInspiration.skip': 'スキップ',
  'visualInspiration.submit': '送信',
  'visualInspiration.closePreview': 'プレビューを閉じる',
  'visualInspiration.noPreview': 'この例のプレビューはありません。',
  ...
  'visualInspiration.contextSelectedLabel': '選択した例',
  'visualInspiration.contextSourceLabel': 'ソース',
  'visualInspiration.contextTagsLabel': '一致タグ',
  'visualInspiration.contextPromptLabel': '例のプロンプト',
  'visualInspiration.contextPreviewLabel': 'プレビュー',
  'visualInspiration.contextNotesLabel': 'ユーザーメモ',
  'visualInspiration.contextInstruction': 'レイアウトのリズム、密度、書体の姿勢、抑えた配色、インタラクションの手がかりの参考として使い、現在のブリーフに合わせて調整してください。保護されたブランドや内容をそのままコピーしないでください。',
  'visualInspiration.contextSkippedBody': '例は選択されませんでした。ブリーフの回答から続行し、最も合うビジュアル方向を自分で選んでください。',
